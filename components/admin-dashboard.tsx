...
interface AdminDashboardProps {
  ...
  onConfigUpdate: (config: CritterConfig) => void
  onConfigCreate: (config: CritterConfig) => void
  onConfigDelete: (config: CritterConfig) => void
                ...
                <Card>
                  <CardHeader className="flex flex-row items-center justify-between">
                    <div>
                      ...
                      {isEditing && (
                        <p className="text-sm text-blue-600 mt-1">🔄 Changes are previewed live and auto-saved</p>
                      )}
                    </div>
                    <div className="flex space-x-2">
                      ...
                      {isEditing ? (
                        <>
                          ...
                          <Button onClick={handleSave} disabled={!formData.businessName || !formData.businessId}>
